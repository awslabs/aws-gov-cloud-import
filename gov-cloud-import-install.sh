...
aws configure set region us-gov-west-1 --profile gov12345
...
aws configure set region us-west-2 --profile com12345
...
EOF
echo ""
echo "Thank you. Checking for Previous Install."
echo ""
echo "INFO: AWS SDK Will show 2 errors if no installation exists."
